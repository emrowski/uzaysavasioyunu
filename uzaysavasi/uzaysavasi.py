...
while True:
    ...
    for hedef in hedefler:
        ...
        if hedef.ycor() < -270 or hedef.distance(oyuncu) < 20:
            yaz.write("EMROWSKİ ÜZGÜN! MALESEF KAYBETTİN!", align="center", font=("Courier", 24, "bold"))
    if len(hedefler) == 0:
        yaz.write("EMROWSKİ! TEBRİK EDER KAZANDINIZ!", align="center", font=("Courier", 24,"bold"))
